...
instance YesodAuth App where
    ...
    authPlugins _ = [authBrowserId def
                    , oauth2Google googleOAuthClientId googleOAuthClientSecret
                    ]

    authHttpManager = getHttpManager


googleOAuthClientId = "747062977919-0ip2v39ja93phq4eo1ict00fhbo7fi54.apps.googleusercontent.com"
googleOAuthClientSecret = "EJs1oGPfXwRvz3MnYzC_-Eg6"
